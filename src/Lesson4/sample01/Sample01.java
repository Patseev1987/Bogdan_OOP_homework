...
public class Sample01 {
    ...
    public static void main(String[] args) {
        ...
        UniversalAccount universalAccount1 = new UniversalAccount("AA11BBB", 1100.15);
        ...
        Account<String> account2 =
                new Account<> ("AAA111BB", 10500);
        Account<Integer> account3 =
                new Account<> (1133, 10500);

        Integer[] array1 = {1, 8, -5, 12, 0, -9};
        String[] array2 = {"AAA", "BBB", "CCCC", "DDDD"};

        Integer[] newArray = (Integer[]) ArrayUtils.replaceTwoElements(array1, 1, 2);
